...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-12">
    ...
    <div>
      ...
      <div className="mt-5">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Educational Content</h3>
        <p className="mt-1 text-gray-600 dark:text-gray-400">High-quality and easily digestible Financial educational content</p>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="mt-5">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Collaborative Budgeting and Expense Tracking</h3>
